...
import { RankingEntry, SetScore } from '../types.ts';
import Card from '../components/ui/Card.tsx';
import Button from '../components/ui/Button.tsx';
import RankingChart from '../components/RankingChart.tsx';
import { PrintIcon, ArrowUpIcon, ArrowDownIcon, ArrowStableIcon, ChevronDownIcon } from '../components/ui/Icons.tsx';
            ...
            .map(player => {
                ...
                if (selectedTournamentId) {
                    ...
                    if (tournamentEloEntries.length > 0) {
                        // Get the ELO before the first tournament event
                        const initialElo = tournamentEloEntries[0].eloBefore;
                                    ...
                                    return (
                                        <React.Fragment key={player.id}>
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-4 font-bold text-sky-600 dark:text-sky-400">{player.currentElo.toFixed(2)}</td>
